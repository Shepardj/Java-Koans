...
public class AboutPrimitives {
	...
	public void wholeNumbersAreOfTypeInt() {
		assertEquals(int.class, getType(1)); // hint: int.class
	}
	...
	public void longsHaveALargerRangeThanInts() {
		...
		assertEquals(Long.MIN_VALUE,temp);
		temp = Long.MAX_VALUE;
		assertEquals(Long.MAX_VALUE,temp);
	}
	...
	public void doublesHaveALargeRange() {
		assertEquals(Double.MIN_VALUE, 0x0.0000000000001p-1022);
		assertEquals(Double.MAX_VALUE, 0x1.fffffffffffffp1023);
	}
