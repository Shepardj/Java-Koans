...
public class AboutLocale {
	...
	public void localizedOutputOfDates() {
		...
		assertEquals(dateformatBR.format(date), "Domingo, 3 de Abril de 2011"); //Lookup how to change this to english, see 2 lines up
		
		Locale localeUS = new Locale("us"); // witch from jp (Japan to US)
